...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-info" id="main_navbar">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li class="nav-item dropdown">
                            <a class="dropdown-item dropdown-toggle" href="#" id="fishfinger" role="button" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                Fish Fingers
                            </a>
                ...
                <li class="nav-item dropdown active">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <!--<div class="dropdown-divider"></div>-->
                        <li class="nav-item dropdown">
                            <a class="dropdown-item dropdown-toggle" href="#" id="Cheddar" role="button" data-toggle="dropdown"
                               aria-haspopup="true" aria-expanded="false">
                                Cheddar Cheese
                            </a>
                            <ul class="dropdown-menu" style="margin-left: 30px; margin-right: 30px" aria-labelledby="fishfinger">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li class="nav-item dropdown">
                            <a class="dropdown-item dropdown-toggle" href="#" id="coffee" role="button" data-toggle="dropdown"
                               aria-haspopup="true" aria-expanded="false">
                                Instant Coffee
                            </a>
                            <ul class="dropdown-menu" style="margin-left: 30px; margin-right: 30px" aria-labelledby="fishfinger">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <!--<div class="dropdown-divider"></div>-->
                        <li class="nav-item dropdown">
                            <a class="dropdown-item dropdown-toggle" href="#" id="panadol" role="button" data-toggle="dropdown"
                               aria-haspopup="true" aria-expanded="false">
                                Panadol
                            </a>
                            <ul class="dropdown-menu" style="margin-left: 30px; margin-right: 30px" aria-labelledby="fishfinger">
